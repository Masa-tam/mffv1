...
{
    EXPECT_EQ(ffv1::syntax::Predictor::median_predict(65535, 32768, 0), 65535);
    EXPECT_EQ(ffv1::syntax::Predictor::median_predict_signed_16bit(65535, 32768, 0), -32768);
}

TEST(PredictorTest, Signed16BitMedianPredictUsesTwosComplementBoundary)
{
    EXPECT_EQ(ffv1::syntax::Predictor::median_predict_signed_16bit(32767, 32768, 65535), 0);
    EXPECT_EQ(ffv1::syntax::Predictor::median_predict_signed_16bit(65535, 65535, 65535), -1);
}
